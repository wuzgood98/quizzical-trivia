        ...
        ? (
          ...
          <div className='animate-fadeIn justify-self-end w-full flex flex-col gap-6 justify-center items-center mt-5'>
            ...
            <div className="flex items-center justify-center flex-wrap gap-5 w-full">
              <button onClick={playAgain} className="self-center basis-[8.5rem] bg-blue200 text-center rounded-xl text-white100 w-full py-3 font-inter text-sm font-semibold tracking-wide transition-transform active:scale-95 sm:text-base">Play again</button>
              <button onClick={restartQuiz} className="self-center basis-[8.5rem] bg-blue200 text-center rounded-xl text-white100 w-full py-3 font-inter text-sm font-semibold tracking-wide transition-transform active:scale-95 sm:text-base">Restart quiz</button>
            </div>
          </div>
        )
      }
